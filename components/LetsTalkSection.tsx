          ...
          <div className="space-y-4 sm:space-y-5 order-1 lg:order-2">
            <div className="space-y-3">
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#12261F] leading-tight">
                ...
                <span className="text-[#BD6908]">expert FX advisory.</span>
              </h2>
            </div>

            <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
              We have helped thousands of businesses trade and thrive globally. Get in touch with our team to learn how we can help you succeed beyond borders.
            </p>
