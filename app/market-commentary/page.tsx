          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-4">
              <span className="text-sm text-[#dce5e1]">
                {new Date(featuredArticle.date).toLocaleDateString("en-AU", {
                  year: "numeric",
                  month: "long",
                  day: "numeric",
                })}
              </span>
              <span className="px-3 py-1 bg-[#12261f] rounded text-xs font-bold">{featuredArticle.currency}</span>
              <Button className="bg-[#bd6908] hover:bg-[#a35a07] text-white font-bold">Read Full Article →</Button>
            </div>
          </div>
        </section>
      )}
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-[#dce5e1]">
                      ...
                      <span className="text-[#bd6908] text-sm font-bold group-hover:gap-2 transition">Read More →</span>
                    </div>
                  </div>
                </Card>
              ))}
